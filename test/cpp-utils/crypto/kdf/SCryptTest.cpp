...
TEST_F(SCryptTest, GeneratedKeyIsReproductible_448) {
    ...
    auto derivedKey = scrypt.deriveNewKey(56, password("mypassword"));
    auto rederivedKey = scrypt.deriveExistingKey(56, password("mypassword"), derivedKey.kdfParameters);
...
TEST_F(SCryptTest, BackwardsCompatibility_448) {
    ...
    auto rederivedKey = scrypt.deriveExistingKey(56, password("mypassword"), kdfParameters);
...
TEST_F(SCryptTest, GeneratedKeyIsReproductible_256) {
    SCrypt scrypt(SCrypt::TestSettings);
    auto derivedKey = scrypt.deriveNewKey(32, password("mypassword"));
    auto rederivedKey = scrypt.deriveExistingKey(32, password("mypassword"), derivedKey.kdfParameters);
    EXPECT_TRUE(keyEquals(derivedKey.key, rederivedKey));
}
...
TEST_F(SCryptTest, BackwardsCompatibility_256) {
    ...
    auto rederivedKey = scrypt.deriveExistingKey(32, password("mypassword"), kdfParameters);
...
TEST_F(SCryptTest, GeneratedKeyIsReproductible_128) {
    SCrypt scrypt(SCrypt::TestSettings);
    auto derivedKey = scrypt.deriveNewKey(16, password("mypassword"));
    auto rederivedKey = scrypt.deriveExistingKey(16, password("mypassword"), derivedKey.kdfParameters);
    EXPECT_TRUE(keyEquals(derivedKey.key, rederivedKey));
}
...
TEST_F(SCryptTest, BackwardsCompatibility_128) {
    ...
    auto rederivedKey = scrypt.deriveExistingKey(16, password("mypassword"), kdfParameters);
...
TEST_F(SCryptTest, DifferentPasswordResultsInDifferentKey) {
    SCrypt scrypt(SCrypt::TestSettings);
    auto derivedKey = scrypt.deriveNewKey(16, password("mypassword"));
    auto rederivedKey = scrypt.deriveExistingKey(16, password("mypassword2"), derivedKey.kdfParameters);
