...
TEST_F(ProgramOptionsTest, BaseDir) {
    const ProgramOptions testobj("/home/user/mydir", "", none, false, false, false, false, none, none, none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, ConfigfileNone) {
    const ProgramOptions testobj("", "", none, true, false, false, false, none, none, none, none, {"./myExecutable"});
    EXPECT_EQ(none, testobj.configFile());
}

TEST_F(ProgramOptionsTest, ConfigfileSome) {
    const ProgramOptions testobj("", "", bf::path("/home/user/configfile"), true, false, false, false, none, none, none, none, {"./myExecutable"});
    EXPECT_EQ("/home/user/configfile", testobj.configFile().get());
}

TEST_F(ProgramOptionsTest, ForegroundFalse) {
    const ProgramOptions testobj("", "", none, false, false, false, false, none, none, none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, CreateMissingBasedirTrue) {
    const ProgramOptions testobj("", "", none, false, false, true, false, none, none, none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, CreateMissingMountpointTrue) {
    const ProgramOptions testobj("", "", none, false, false, false, true, none, none, none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, LogfileSome) {
    const ProgramOptions testobj("", "", none, true, false, false, false, none, bf::path("logfile"), none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, UnmountAfterIdleMinutesSome) {
    const ProgramOptions testobj("", "", none, true, false, false, false, 10, none, none, none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, CipherSome) {
    const ProgramOptions testobj("", "", none, true, false, false, false, none, none, string("aes-256-gcm"), none, {"./myExecutable"});
...
TEST_F(ProgramOptionsTest, BlocksizeBytesSome) {
    const ProgramOptions testobj("", "", none, true, false, false, false, none, none, none, 10*1024, {"./myExecutable"});
    EXPECT_EQ(10*1024u, testobj.blocksizeBytes().get());
}

TEST_F(ProgramOptionsTest, EmptyFuseOptions) {
    const ProgramOptions testobj("/rootDir", "/home/user/mydir", none, false, false, false, false, none, none, none, none, {});
...
TEST_F(ProgramOptionsTest, SomeFuseOptions) {
    const ProgramOptions testobj("/rootDir", "/home/user/mydir", none, false, false, false, false, none, none, none, none, {"-f", "--longoption"});
    //Fuse should have the mount dir as first parameter
